...
export function MyThesesPageClient() {
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-lg font-semibold hover:bg-blue-600 dark:hover:bg-blue-500 transition-all"
            >
              Zur Startseite
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6">
          <Link
            href="/"
            className="inline-flex items-center text-sm text-gray-600 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-500 mb-4 transition-colors"
          >
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="p-2 text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                ...
                <div className="flex items-center text-yellow-600 dark:text-yellow-500 font-medium group-hover:gap-2 transition-all">
